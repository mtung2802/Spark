...
# dataFile.where("actor.id < 200000").show()

# dataFile.select(col("id"), col("actor.id").alias("tungdepzai")).filter((col("id") == "2615567732") & (col("actor.id") == 19299)).show()
dataFile.filter(length(col("id")) < 11).show()
